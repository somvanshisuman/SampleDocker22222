...
import Sprint1.Eccomerce.UserService;
...
import Sprint1.Eccomerce.repo.CartRepo;
import Sprint1.Eccomerce.repo.PaymentRepo;
import Sprint1.Eccomerce.repo.ShoppingInterface;
...
public class Controller123 {
	...
	@GetMapping(path = "/cartresult")
	public String getUsers9678() {
		return "cartresult";
	}
