...
<body>
	<div class="main">
		...
		<div align=center><span id="val" > </span>
       ...
       <h4 style=" text-align: center;"><a title="Print Screen" alt="Print Screen" onclick="window.print();"    target="_blank" style="cursor:pointer;"> 
       <button>TAKE BILL</button></a></h4>
       <button><a href="/customer/insertpayment">Payment</a></button></a></h4>
